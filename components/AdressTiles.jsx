    ...
    <>
      <div className="flex w-full gap-3 flex-wrap justify-center item-center">
          <div className="bg-white border w-44 h-44 text-center p-2 shadow-lg rounded">
            <div className='text-[#0092FF]'><i className=" fa-solid fa-location-dot fa-4x"></i></div>
          ...
          <div className="bg-white border w-44 h-44 text-center p-2 shadow-lg rounded">
            <div className='text-[#0092FF]'><i className=" fa-duotone fa-phone  fa-4x"></i></div>
          ...
          <div className="bg-white border w-44 h-44 text-center p-2 shadow-lg rounded">
            <div className='text-[#0092FF]'><i className=" fa-duotone fa-fax  fa-4x"></i></div>
