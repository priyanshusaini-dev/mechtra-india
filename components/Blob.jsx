...
const Blob = () => {
 ...
 .share .twitter {
	 ...
	 overflow: visible;
       ...
       `}</style>
       <i className="fa-solid fa-arrow-up absolute top-[6vh] right-[1.8rem]  cursor-pointer text-white fa-xl"></i>
            <svg className="blob cursor-pointer" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
